...
};e.set=function(r,n,s){var p,q,l,o,k;function t(u){if(u){switch(r){case true:u.addSelection();
break;case false:u.removeSelection(true);break;default:u.toggleSelection();break;
}}}function j(u){if(u&&a.inArray(u,k)<0){k.push(u);o+=(o===""?"":",")+u.key;}}function m(u){a.each(k,function(w,v){t(v);
});if(!r){u.removeSelectionFinish();}if(l&&u.options.boundList){d.setBoundListProperties(u.options,d.getBoundList(u.options,o),r);
...
};c._addShapeGroupImpl=function(e,i){var h=this,g=h.map_data,f=e.effectiveRenderOptions(i);
a.each(e.areas(),function(k,j){var l=f;l.isMask=f.isMask||(j.nohref&&g.options.noHrefIsMask);
h.addShape(j,l);});};c.addShapeGroup=function(e,j){var i=this,g,k,f,h=this.map_data,l=e.effectiveRenderOptions(j);
...
if(!i||i.isNotRendered()||i.owner.currentAction){return;}l=i.effectiveOptions();if(f.currentAreaId===i.areaId){return;
