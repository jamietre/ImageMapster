...
if(i.toolTipClose&&a.inArray("area-mouseout",i.toolTipClose)>=0&&this.activeToolTip){window.setTimeout(function(){if(!f.cancelClear){f.clearTooltip()
}f.cancelClear=false
},50)
}f.currentAreaId=-1
};
...
i.cancelClear=false;
if(i.activeToolTipID===this.areaId){i.cancelClear=true;
return
