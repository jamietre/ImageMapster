...
if(!w.options.isMask){l(w);}});}}m.preventDefault();if(i&&!i.owner.currentAction){q=f.options;
l(i);}};this.graphics=new b.Graphics(this);};c=b.MapData.prototype;c.initializeDefaults=function(){this.images=[];
...
z.processCommandQueue();if(A.onConfigured&&typeof A.onConfigured==="function"){A.onConfigured.call(s,true);
