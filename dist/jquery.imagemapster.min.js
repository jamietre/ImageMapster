...
if(!c[d]){c=c.splice(d,1);}}return c;},setOpacity:function(c,d){if(!a.mapster.hasCanvas){c.style.filter="Alpha(opacity="+String(d*100)+")";
}else{c.style.opacity=d;}},updateProps:function(c,d){var e,f=c||{},g=a.isEmptyObject(f)?d:c;
...
i._addShapeGroupImpl(m,j);});}i._addShapeGroupImpl(e,j);i.render();if(l.fade){d.fader(f,0,1,l.fadeDuration);
