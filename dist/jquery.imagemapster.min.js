...
b.utils["img"+c]=function(e){return e[d]||e["natural"+c]||e["client"+c]||e["offset"+c];
};b.utils["imgR"+c]=function(e){return a(e)[d]()||b.utils["img"+c](e);};});b.Method=function(g,d,c,f){var e=this;
e.name=f.name;e.output=g;e.input=g;e.first=f.first||false;e.args=f.args?Array.prototype.slice.call(f.args,0):[];
e.key=f.key;e.func_map=d;e.func_area=c;e.name=f.name;e.allowAsync=f.allowAsync||false;
};b.Method.prototype.go=function(){var f,e,c,g,j,k=this.input,d=[],h=this;g=k.length;
for(f=0;f<g;f++){e=a.mapster.getMapData(k[f]);if(e){if(!h.allowAsync&&b.queueCommand(e,h.input,h.name,h.args)){if(this.first){j="";
...
});a(g).attr("src",k);}else{m(g);}};c.isImageLoaded=function(f){var e,g=this;if(g.imageStatus[f]){return true;
}e=g.images[f];if(typeof e.complete!=="undefined"&&!e.complete){return false;}g.imageStatus[f]=!!d.imgWidth(e);
return g.imageStatus[f];};c.bindImages=function(f,e){var g,j=this,h=true,k=j.options,l=function(){j.bindImages.call(j,false,e);
...
};b.utils.scaleMap=function(e,f,g){function h(i){var j={width:d.imgRWidth(i),height:d.imgRHeight(i)};
...
}return j;}return this.getScaleInfo(h(e),g?h(f):null);};b.MapData.prototype.resize=function(n,l,f){var j,p,s,i,e,o={},m,g,k=this;
...
}k.processCommandQueue();}function q(){a(k.image).css(m);k.scaleInfo=d.getScaleInfo({width:s,height:i},{width:k.scaleInfo.realWidth,height:k.scaleInfo.realHeight});
