...
l.imagesLoaded=false;if(l.images.length>2){l.images=l.images.slice(0,2);l.imageSources=l.imageSources.slice(0,2);
l.imageStatus=l.imageStatus.slice(0,2);l.altImagesXref={};}l.altImagesXref={};if(l.images.length===0){l.addImage(l.image);
l.addImage(null,l.image.src);}if(a.mapster.hasCanvas){l.addImage(null,m.render_highlight.altImage||m.altImage,"highlight");
...
}return;}if(l.bindTries-->0){this.imgTimeout=window.setTimeout(n,50);}else{f();}};
