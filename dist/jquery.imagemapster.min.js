...
e.clip();e.globalAlpha=h.altImageOpacity;e.drawImage(f,0,0,g.owner.scaleInfo.width,g.owner.scaleInfo.height);
...
}else{if(m.options.fill){k.beginPath();i.renderShape(k,m.mapArea);k.closePath();k.fillStyle=i.css3color(m.options.fillColor,m.options.fillOpacity);
