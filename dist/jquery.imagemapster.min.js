...
a.each(e.areas(),function(k,j){var l=e.effectiveRenderOptions(h);
...
if(f.options.showToolTip){a.each(j,function(){if(this.effectiveOptions().toolTip){this.showTooltip()
}})
