...
this.clearMapData(j);h(this);},null,{name:"unbind",args:arguments})).go();};e.rebind=function(j){return(new d.Method(this,function(){this.configureOptions(j);
this.buildDataset(true);},null,{name:"rebind",args:arguments})).go();};e.get_options=function(l,k){var j=i.isBool(l)?l:k;
...
this.options=e;this.bindTries=e.configTimeout/50;};c.initializeDefaults=function(){this.images=[];
...
this.commands=[];this.data=[];this.mapAreas=[];this._xref={};this.highlightId=-1;
this.currentAreaId=-1;this._tooltip_events=[];this.scaleInfo=null;this.index=-1;this.currentAreaId=-1;
this.activeAreaEvent=null;};c.isActive=function(){return !this.complete||this.currentAction;
...
}k.complete=true;h=a(k.image);n=h.parent().attr("id");if(n&&n.length>=12&&n.substring(0,12)==="mapster_wrap"){r=h.parent();
...
s=s.value;return p(i,s);});}k.options.boundList=l.onGetList.call(k.image,q);}k.processCommandQueue();
if(l.onConfigured&&typeof l.onConfigured==="function"){l.onConfigured.call(h,true);
