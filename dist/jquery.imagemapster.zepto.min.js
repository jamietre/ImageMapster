...
k=a(y.map).find(D);y.scaleInfo=C=d.scaleMap(s,y.images[1],z.scaleMap);for(r=k.length-1;
...
if(z.sortList){if(z.sortList==="desc"){E=function(i,j){return i===j?0:(i>j?-1:1);
};}else{E=function(i,j){return i===j?0:(i<j?-1:1);};}F.sort(function(i,j){i=i.value;
j=j.value;return E(i,j);});}y.options.boundList=z.onGetList.call(y.image,F);}y.redrawSelections();
...
}return f;};c.coords=function(f){var e=[];a.each(this.areas(),function(h,g){e=e.concat(g.coords(f));
...
g.keys=d.split(f);};b.MapArea.prototype.coords=function(e){return a.map(this.originalCoords,function(f){return e?f:f+e;
...
}return k;};}(jQuery));(function(a){var b=a.mapster.utils;b.areaCorners=function(e,x,o){var n,t,u,r,s,h,f,i,g,l,m,v,q,p,w,c,d,k=[];
