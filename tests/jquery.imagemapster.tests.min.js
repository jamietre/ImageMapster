...
});}u=false;y=$("#usa_image");y.mapster("test",'if (typeof u!=="undefined") {u.old=u.isImageLoaded;u.isImageLoaded=function(){return false;};}');
...
C.assertIsTruthy(false,B);}catch(x){C.assertIsTruthy(true,B);}y.mapster("test",'if (typeof u !== "undefined") {u.isImageLoaded=u.old;}');
