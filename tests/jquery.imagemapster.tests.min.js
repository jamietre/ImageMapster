...
$('area[state="RI"]').first().click();A.assertEq(h.mapster("get"),"RI","New single state selected");
h.mapster("rebind",{singleSelect:false,isDeselectable:true,areas:[{key:"ME",isDeselectable:false}]});
$('area[state="RI"]').first().click();A.assertEq(h.mapster("get","RI"),false,"Was able to deselect item after removing singleSelect");
...
v=p.find("var").children();x=r(v);w.assertEq(94,v.length,"Correct # of shapes found on initial rendering for TX staticState=true");
